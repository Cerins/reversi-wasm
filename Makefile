...
EXPORTED_FUNCTIONS = -s EXPORTED_FUNCTIONS='["_createReversi", "_destroyReversi", "_passCheck", "_getBoard", "_getEvent", "_getTurn", "_playerMove", "_countWhitePoints", "_countBlackPoints", "_main", "_computerMove"]'
